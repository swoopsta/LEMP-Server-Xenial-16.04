...
Unfortunately, Google has abandoned the official Nginx Brotli module. Instead we're going to be using a [forked version](https://github.com/eustas/ngx_brotli) that has more regular updates and still works with the latest builds of Nginx.
```
cd /usr/src
